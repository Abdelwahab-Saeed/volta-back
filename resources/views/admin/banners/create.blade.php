    ...
    <form action="{{ route('admin.banners.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="space-y-6">
            ...
            <div>
                ...
                <input type="text" name="title" id="title" value="{{ old('title') }}" placeholder="مثلاً: خصومات الشتاء"
            ...
            <div>
                ...
                <textarea name="description" id="description" rows="3" placeholder="اكتب وصفاً جذاباً للبانر..."
            ...
            <!-- Image -->
            <div>
                <label for="image" class="block text-sm font-bold text-gray-700 mb-2">صورة البانر</label>
