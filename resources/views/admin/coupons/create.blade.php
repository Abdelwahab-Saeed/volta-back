    ...
    <form action="{{ route('admin.coupons.store') }}" method="POST">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="md:col-span-2">
                ...
                <input type="text" name="code" id="code" value="{{ old('code') }}" placeholder="مثلاً: SAVE20"
            ...
            <div>
                ...
                <input type="number" name="value" id="value" value="{{ old('value') }}" placeholder="مثلاً: 10"
            ...
            <div>
                ...
                <input type="number" name="min_order_amount" id="min_order_amount" value="{{ old('min_order_amount') }}" placeholder="اختياري"
                    class="w-full px-4 py-2.5 rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all outline-none">
            </div>
            ...
            <div>
                ...
                <input type="number" name="max_uses" id="max_uses" value="{{ old('max_uses') }}" placeholder="اختياري"
                    class="w-full px-4 py-2.5 rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all outline-none">
            </div>
