...
<div class="max-w-2xl bg-white rounded-2xl shadow-sm border border-gray-100 p-8 text-right">
    <form action="{{ route('admin.posts.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="space-y-6">
            <!-- Title -->
            @include('admin.partials.translatable-field', ['field' => 'title'])

            <!-- Description -->
            @include('admin.partials.translatable-field', ['field' => 'description', 'textarea' => true, 'rows' => 10])

            <!-- Image -->
            <div>
                <label for="image" class="block text-sm font-bold text-gray-700 mb-2">صورة المقال</label>
            ...
            <div class="pt-4 flex space-x-reverse space-x-4">
                ...
                <a href="{{ route('admin.posts.index') }}" class="px-10 py-2.5 text-gray-500 hover:bg-gray-100 rounded-xl transition-all font-bold">
                    إلغاء
                </a>
            </div>
        </div>
