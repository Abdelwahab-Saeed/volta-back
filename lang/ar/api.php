...
return [
    ...
    'category_fetched' => 'تم جلب بيانات القسم بنجاح',
    'error_admin_only' => 'يرجى استخدام لوحة تحكم المسؤول للإدارة أو تحديث تطبيق API',
    'cart_empty' => 'السلة فارغة حالياً',
    'cart_fetched' => 'تم جلب بيانات السلة بنجاح',
    'cart_item_added' => 'تم إضافة المنتج إلى السلة بنجاح',
